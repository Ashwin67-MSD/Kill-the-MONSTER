...
function setup() {
  ...
  box8 = new Box(900, 110, 70, 70);
  box9 = new Box(900, 110, 70, 70);
  box10 = new Box(900, 110, 70, 70);
  box11 = new Box(900, 110, 70, 70);
  box12 = new Box(900, 110, 70, 70);
  box13 = new Box(900, 110, 70, 70); 
  box14 = new Box(900, 110, 70, 70);
